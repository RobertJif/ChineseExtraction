...
public class reader7 {
    ...
    String allkr7 = "";
    static File f = new File("C:\\Users\\Robert\\Documents\\NetBeansProjects\\ChineseExtraction\\TrueTraining\\TrainingGoresan7\\");
...
//             System.out.println("");
             setAllkorelasi7(list[urutan[ii]].getName(), nilaikorelasinya[ii]);
    ...
    public void setAllkorelasi7(String input,double input2){
        allkr7 = allkr7 + input + " = " + input2 + "\n";
        
    }
    public String getAllkorelasi7(){
        return allkr7;
    }
